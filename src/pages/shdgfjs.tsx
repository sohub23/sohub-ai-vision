...
import { Camera, Cpu, Box, Zap, Shield, Settings, ChevronDown, Check, Plus, ArrowLeft, WifiOff, Clock, BadgeCheck, Eye, Thermometer, Flame, ShoppingBag, ArrowRight, Activity, Users } from "lucide-react";
...
const aiModels = [
    { icon: <Eye className="w-4 h-4" />, name: "Intrusion & Perimeter", desc: "Line crossing & zone breach" },
    { icon: <Flame className="w-4 h-4" />, name: "Fire & Smoke", desc: "Early warning & extinguiser det." },
    { icon: <Shield className="w-4 h-4" />, name: "PPE & Safety", desc: "Helmet & Hi-Vis compliance" },
    { icon: <Activity className="w-4 h-4" />, name: "Human Behavior", desc: "Fall, smoking & loitering det." },
    { icon: <Users className="w-4 h-4" />, name: "Flow Analysis", desc: "People counting & crowd density" },
    { icon: <Clock className="w-4 h-4" />, name: "Operational", desc: "Absence & supervisor departure" },
];
...
const ProductStandaloneCamera = () => {
    ...
    return (
        <div className="min-h-screen bg-background">
            <SEOHead
                title="SOHUB Vision AI Camera – All-in-One Smart AI Camera | From ৳8,000"
                description="4MP Full-Color AI camera with 13+ built-in algorithms. IP66 weatherproof, ≥120dB WDR, and offline processing. Starting from ৳8,000."
