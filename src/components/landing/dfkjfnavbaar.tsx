...
const Navbar = () => {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-50">
            ...
            >
                <div className="container mx-auto max-w-[1200px] px-4 sm:px-6 md:px-8 py-2">
            ...
            >
                <div className="container mx-auto max-w-[1200px] px-4 sm:px-6 md:px-8 flex items-center justify-between h-16">
